...
public class AfterAopAspect {
	...
	@AfterReturning(value = "execution(* com.cdac.service.*.*(..))", returning = "result123")
	...
	@After(value = "execution(* com.cdac.controller.*.*(..))")
	...
	@AfterThrowing(value = "execution(* com.cdac.service.*.*(..))", throwing = "exc")
